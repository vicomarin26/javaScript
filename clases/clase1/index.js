...
//fomra de declaracion una variable no recomendada
/* var edad;
//fomra de declaracion una variable recomendada
let nombre = "andres";
let numero = 2;  */
...
console.log("aca esta el resultado de la suma", suma); */
...
function myPrimeraFuncion() {
    ...
    let suma = numeroUno + numeroDos;
    let mensajeSuma = `la suma del numero uno = ${numeroUno} más la suma del numero dos = ${numeroDos} es igual a = ${suma} `;
    if (mensajeSuma != null) {
